...
Original file is located at
    https://colab.research.google.com/drive/1hwtFWSAqy89OoOyhtSaTxxq_kjvID2A4
"""
...
hourly_returns = merged_df['strategy_returns']
...
btc_cum_returns = (1 + merged_df['returns']).cumprod()
strategy_cum_returns = (1 + merged_df['strategy_returns']).cumprod()

# Plotting
plt.figure(figsize=(12, 6))
plt.plot(merged_df['datetime'], btc_cum_returns, label='BTC Returns', color='blue')
plt.plot(merged_df['datetime'], strategy_cum_returns, label='Strategy Returns', color='orange')
